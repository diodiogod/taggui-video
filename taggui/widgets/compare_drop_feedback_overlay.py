...
def _draw_progress_border(painter: QPainter, rect: QRect, ratio: float, color: QColor):
...
def _paint_feedback(painter: QPainter, rect: QRect, *, state: str, progress: float):
...
class CompareDropFeedbackOverlay(QWidget):
    """Transparent top-level overlay for compare drag feedback."""
