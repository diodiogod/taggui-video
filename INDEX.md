...
- `image_list_masonry_incremental_service.py`: Per-page masonry cache for incremental scroll updates (append new pages without full recalc).
- `image_list_masonry_context.py`: Shared dataclass for masonry calculation-phase context/state.
