...
- Restore external media dragging and prevent video-list flashing
- Make Alt-drag to other Windows applications work again
- Reduce native drag exposure to MPV and OpenGL-backed surfaces
- Stop valid portrait and panorama videos from being reset and repeatedly rearranging the image list
## [1.6.4] - 2026-08-28
...
- Make the volume popup clearer over both bright and dark videos
- Allow one continuous press-and-hold gesture to adjust volume
- Start volume changes only after the pointer enters the slider track

### Changed

- Improve video playback and volume controls

### Fixed

- Fix intermittent play and pause button clicks
## [1.4.5] - 2026-07-23
...
- Add Ctrl-click filtering for review badges
- Ctrl-click review toolbar badges to add matching filters to the image list
- Keep normal click behavior for applying or removing review badges
- Make review badge filtering match the existing rating and reaction toolbar workflow
## [1.2.1] - 2026-04-16
...
- Add masonry review wall and review badges
- Open a multi-selection as a masonry wall of floating viewers for fast comparison
- Auto-sync and auto-play grouped videos in the review wall
- Add persistent review badges that show in the wall, toolbar, and image list
- Let you customize badge symbols, colors, tooltips, shortcuts, and appearance in Settings
- Add clear selected and clear current folder actions for review badges
- Add documentation for the masonry review wall and badge workflow

### Changed

- Improve wall startup, bulk close responsiveness, and settings dialog sizing
## [1.1.4] - 2026-04-14
